...
<%
List<Test1> list1 = (List<Test1>)request.getAttribute("allTest");
...
%>
	...
	<div class="container-fluid">
		...
		<form action="${pageContext.servletContext.contextPath}/formActivate"
	...
	<table class="table table-striped" >
		...
		out.print("<tr>");
		  out.print("<td>"+ test.getId() +"</td>");
		  out.print("<td>"+ test.getTestName() + "</td>");
		  out.print("<td>"+ test.getTestDuration()+ "</td>");
		  out.print("<td>"+ test.getTestStatus()+ "</td>");
		out.print("</tr>");
